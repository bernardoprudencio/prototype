...
// ── Main ───────────────────────────────────────────────────────────────────────
export default function ScheduleScreen({ onBack: onBackProp, owner: ownerProp = {}, onEditTemplate: onEditTemplateProp, onManageCurrentWeek: onManageCurrentWeekProp }) {
  const ownerId = ownerProp?.id ?? 'owen'
  const {
  ...
  const onEditTemplate = onEditTemplateProp ?? (() => {})
  const onManageCurrentWeek = onManageCurrentWeekProp ?? (() => {})
